...
440 S = (sqrt(V*V + 2*A*G)-V) / G
    V = V+G*S
    L = L+S

510 write(*,30) "ON THE MOON AT", L, " SECS"
    W = 3600*V
520 write(*,30) "IMPACT VELOCITY OF", W, " M.P.H."
    write(*,30) "FUEL LEFT:", M-N, " LBS"
540 if(W.gt.1) goto 550
...
583 write(*,30) "IN FACT YOU BLASTED A NEW LUNAR CRATER", W*0.277777, " FT.DEEP."
